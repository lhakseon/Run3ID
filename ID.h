...
// Wed Apr 20 06:11:52 2022 by ROOT version 6.14/09
// from TTree eventTree/event tree for analysis
// found on file: MC_GJet_Pt_40toInf_DoubleEMEnriched_MGG_80toInf_98.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nIsoTrack;
   Bool_t          IsoTrack_isHighPurityTrack[34];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[34];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[34];   //[nIsoTrack]
   Short_t         IsoTrack_charge[34];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[34];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[34];   //[nIsoTrack]
   Float_t         IsoTrack_dxy[34];   //[nIsoTrack]
   Float_t         IsoTrack_dz[34];   //[nIsoTrack]
   Float_t         IsoTrack_eta[34];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[34];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[34];   //[nIsoTrack]
   Float_t         IsoTrack_phi[34];   //[nIsoTrack]
   Float_t         IsoTrack_pt[34];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[34];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[34];   //[nIsoTrack]
   Int_t           nJet;
   ...
   Int_t           nPhoton;
   Char_t          Photon_seediEtaOriX[9];   //[nPhoton]
   ...
   Int_t           Photon_seediPhiOriY[9];   //[nPhoton]
   ...
   Float_t         TkMET_sumEt;
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[75];   //[nTrigObj]
   UShort_t        TrigObj_id[75];   //[nTrigObj]
   Int_t           TrigObj_l1iso[75];   //[nTrigObj]
   Int_t           TrigObj_filterBits[75];   //[nTrigObj]
   Float_t         TrigObj_pt[75];   //[nTrigObj]
   Float_t         TrigObj_eta[75];   //[nTrigObj]
   Float_t         TrigObj_phi[75];   //[nTrigObj]
   Float_t         TrigObj_l1pt[75];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[75];   //[nTrigObj]
   Float_t         TrigObj_l2pt[75];   //[nTrigObj]
   Int_t           genTtbarId;
   Int_t           nOtherPV;
   ...
   Float_t         PV_score;
   Int_t           nSV;
   Short_t         SV_charge[34];   //[nSV]
   Float_t         SV_dlen[34];   //[nSV]
   Float_t         SV_dlenSig[34];   //[nSV]
   Float_t         SV_dxy[34];   //[nSV]
   Float_t         SV_dxySig[34];   //[nSV]
   Float_t         SV_pAngle[34];   //[nSV]
   ...
   UChar_t         SubJet_hadronFlavour[11];   //[nSubJet]
   UChar_t         SubJet_nBHadrons[11];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[11];   //[nSubJet]
   UChar_t         SV_ntracks[34];   //[nSV]
   Float_t         SV_chi2[34];   //[nSV]
   Float_t         SV_eta[34];   //[nSV]
   Float_t         SV_mass[34];   //[nSV]
   Float_t         SV_ndof[34];   //[nSV]
   Float_t         SV_phi[34];   //[nSV]
   Float_t         SV_pt[34];   //[nSV]
   Float_t         SV_x[34];   //[nSV]
   Float_t         SV_y[34];   //[nSV]
   Float_t         SV_z[34];   //[nSV]
...
ID(const char* file1, const char* file2);
   virtual ~ID();
...
#ifdef ID_cxx
/*ID::ID(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MC_GJet_Pt_40toInf_DoubleEMEnriched_MGG_80toInf_98.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MC_GJet_Pt_40toInf_DoubleEMEnriched_MGG_80toInf_98.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("MC_GJet_Pt_40toInf_DoubleEMEnriched_MGG_80toInf_98.root:/phoJetNtuplizer");
...
*/
ID::ID(const char* file1, const char* file2)
{
...
Int_t ID::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ID::LoadTree(Long64_t entry)
{
